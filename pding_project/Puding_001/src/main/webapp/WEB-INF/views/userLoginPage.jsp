...
<body>
	<p class="login_title">  �� 留��� ��鍮��ㅻ�� �댁�⑺�����ㅻ㈃ 濡�洹몄�� �댁＜�몄��.</p>
...
console.log(Kakao.isInitialized()); // sdk珥�湲고���щ�����
//移댁뭅�ㅻ�洹몄��
var userData = '';
var jsonData = '';
function kakaoLogin() {
  ...
  function ajaxResult(jsonData){
$.ajax({
	  
    url: "main", // 클라이언트가 요청을 보낼 서버의 URL 주소
    data: {'response' : jsonData},                // HTTP 요청과 함께 서버로 보낼 데이터
    type: "GET",                             // HTTP 요청 방식(GET, POST)                 // 서버에서 보내줄 데이터의 타입
    success : function(data){
    	console.log("AjaxData====>"+data);
    	window.location.href = 'http://localhost:8080/mypudingapp/main';
    },
    error : function(data){
